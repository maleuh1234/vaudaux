    ...
    <footer>
        ...
        <div>
            <nav class="main-nav">
                ...
                <RouterLink @click="closeMenu" to="/knowHow">{{textes[currentLang].know}}</RouterLink>
                <RouterLink @click="closeMenu" to="/history">{{textes[currentLang].hist}}</RouterLink>
                <RouterLink @click="closeMenu" to="/values">{{textes[currentLang].value}}</RouterLink>
