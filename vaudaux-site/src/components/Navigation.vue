<template>
  ...
  <div class="opened-burger" :class="{ 'active': isToggled }">
    ...
    <!-- changer lien pour la dpd -->
    <a class="legal" href="https://docs.google.com/document/d/1-odQ161aj1DAq6wljdHrafA8wjoTDU00/edit?usp=sharing&ouid=117838288663904003205&rtpof=true&sd=true"  target="_blank" rel="noopener noreferrer">Mentions légales</a>
  </div>
</template>
